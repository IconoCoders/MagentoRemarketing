...
/**
 * Iconocoders_Remarketing_Model_Observer
 *
...
class Iconocoders_Remarketing_Model_Observer
{
    /**
     * addItemToCart event
     */
    ...
    /**
     * onCustomerNewsletterSubscribe event
     */
    ...
    /**
     * postdispatchNewsletterManageSave event
     */
    ...
    public function insertLeadBlockTemplate($observer)
    {
        ...
        if ($_subscriber && $_subscriber->getEmail()) {
            ...
            $template_name = 'iconoocoders/remarketing/lead.phtml';
        }
        ...
        if ($_customer && $_customer->getValue()) {
            $add_custom_block = true;
            $template_name = 'iconoocoders/remarketing/completeregistration.phtml';
        }
