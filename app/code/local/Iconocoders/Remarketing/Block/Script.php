...
/**
 * Iconocoders_Remarketing_Block_Script
 *
...
class Iconocoders_Remarketing_Block_Script extends Mage_Core_Block_Template {
     ...
     */
    private $_useTemplate		= 'remarketing/ga/script.phtml';
    ...
    public function _construct()
    {
        ...
        $this->_productAttribute 	= Mage::getStoreConfig('iconocoders_remarketing/tracking/ga_attribute_key',$this->_store);
    }
    ...
    public function getJsConfigParams()
    {
        ...
        return Mage::helper('iconocoders_remarketing')->getJsObjectString($_params);
    }
